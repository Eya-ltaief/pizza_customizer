...
const Customize = ({ingredients, setIngredients}) => {
    ...
    return (
        <div style={{display:"flex", marginTop:'72px', marginLeft:'10px'}}>
            <div style={{flex:1}}>
                <div style={{maxHeight:"200",maxWidth:"200", position:"relative"}}>
                    <motion.div
                    initial={{ opacity: 0 }}
                    animate={{
                ...
                >
                    <img src={Basil} alt="Pizza Base" height="82%" width="82%" />
                </motion.div>
                <motion.div
                    initial={{ opacity: 0 }}
                    animate={{
                    ...
                    className="ingredients z4"
                >
                    <img src={Olive} alt="Pizza Base" height="82%" width="82%" />
                </motion.div>
                ...
                >
                    <img src={Pineapple} alt="Pizza Base" height="82%" width="82%" />
                </motion.div>
                <motion.div
                    initial={{ opacity: 0 }}
                    animate={{
                    ...
                    className="ingredients z4"
                >
                    <img src={Tomato} alt="Tomato" height="82%" width="82%" />
                </motion.div>
                <motion.div
                    initial={{ scale: 0 }}
                    animate={{
                    ...
                    className="cheese z1"
                >
                    <img src={BaseCheese} alt="Cheese" height="82%" width="82%" />
                </motion.div>
                ...
                <motion.div
                    ...
                    className="ingredients z4"
                >
                    <img src={Mushroom} alt="Pizza Base" height="82%" width="82%" />
                </motion.div>

                <motion.div transition={{ duration: 1 }} className="">
                    <img src={PizzaBase} alt="Pizza Base" height="82%" width="82%" />
                </motion.div>
            </div>
        </div>     
